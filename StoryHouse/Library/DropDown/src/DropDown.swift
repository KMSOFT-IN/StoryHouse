...
public final class DropDown: UIView {
	...
	*/
	@objc public dynamic var cornerRadiuss = DPDConstant.UI.CornerRadius {
		willSet {
	...
	*/
	@objc public dynamic var shadowColorr = DPDConstant.UI.Shadow.Color {
	...
	Changing the shadow color automatically reloads the drop down.
	*/
	@objc public dynamic var shadowOffsett = DPDConstant.UI.Shadow.Offset {
	...
	*/
	@objc public dynamic var shadowOpacityy = DPDConstant.UI.Shadow.Opacity {
	...
	*/
	@objc public dynamic var shadowRadiuss = DPDConstant.UI.Shadow.Radius {
...
private extension DropDown {
	...
	func setupUI() {
		...
		tableViewContainer.layer.cornerRadius = cornerRadiuss
		tableViewContainer.layer.shadowColor = shadowColorr.cgColor
		tableViewContainer.layer.shadowOffset = shadowOffsett
		tableViewContainer.layer.shadowOpacity = shadowOpacityy
		tableViewContainer.layer.shadowRadius = shadowRadiuss

		tableView.backgroundColor = tableViewBackgroundColor
		tableView.separatorColor = separatorColor
		tableView.layer.cornerRadius = cornerRadiuss
